...
public enum AdvancedByteBufFormat {
    ...
    public LoggingHandler toLoggingHandler(String category, LogLevel level, Charset charset) {
        switch (this) {
            case SIMPLE:
                return new WiretapLoggingHandler(category, level, SIMPLE);
            case HEX_DUMP:
                return new WiretapLoggingHandler(category, level, HEX_DUMP);
            default:
                return new WiretapLoggingHandler(category, level, charset);
        }
    }
}
