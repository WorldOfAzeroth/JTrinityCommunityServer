...
package com.github.jtrinity.net.wiretap;
...
import static com.github.jtrinity.net.wiretap.AdvancedByteBufFormat.HEX_DUMP;
import static com.github.jtrinity.net.wiretap.AdvancedByteBufFormat.TEXTUAL;
import static io.netty.buffer.ByteBufUtil.appendPrettyHexDump;
import static io.netty.util.internal.StringUtil.NEWLINE;
import static java.util.Objects.requireNonNull;


final class WiretapLoggingHandler extends LoggingHandler {
     ...
     */
    WiretapLoggingHandler(String name, LogLevel level, AdvancedByteBufFormat byteBufFormat) {
     ...
     */
    WiretapLoggingHandler(final String name, final LogLevel level, final Charset charset) {
        super(name, level);
    ...
    public ByteBufFormat byteBufFormat() {
        if (byteBufFormat == AdvancedByteBufFormat.SIMPLE) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WiretapLoggingHandler)) {
            return false;
        }
        WiretapLoggingHandler that = (WiretapLoggingHandler) o;
