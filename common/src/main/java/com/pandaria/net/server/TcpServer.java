package com.pandaria.net.server;

import com.pandaria.net.*;
import com.pandaria.net.ssl.SslProvider;
import com.pandaria.utils.AddressUtils;
import com.pandaria.net.wiretap.AdvancedByteBufFormat;
...
public abstract class TcpServer<T extends TcpServer<T>> {
    ...
    public T host(String host) {
        ...
        return bindAddress(() -> AddressUtils.updateHost(bindAddress, host));
    }

    public T port(int port) {
        return bindAddress(() -> AddressUtils.updatePort(bindAddress, port));
    }
