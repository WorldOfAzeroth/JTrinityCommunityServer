...
@Db2DataBind(name = "VehicleSeat.db2", layoutHash = 0x242E0ECD, fields = {
        ...
        @Db2Field(name = "attachmentOffsetX", type = Db2Type.FLOAT),
        @Db2Field(name = "attachmentOffsetY", type = Db2Type.FLOAT),
        @Db2Field(name = "attachmentOffsetZ", type = Db2Type.FLOAT),
        ...
        @Db2Field(name = "cameraOffsetX", type = Db2Type.FLOAT),
        @Db2Field(name = "cameraOffsetY", type = Db2Type.FLOAT),
        @Db2Field(name = "cameraOffsetZ", type = Db2Type.FLOAT),
